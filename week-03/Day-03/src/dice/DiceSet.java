...
public class DiceSet {
  ...
  public static void main(String[] args) {
   ...
   int win = 6 * six;
    ...
    diceSet.roll();
    while ((diceSet.getCurrent(0) != win) && (diceSet.getCurrent(1) != win) && (diceSet.getCurrent(2) != win) && (diceSet.getCurrent(3) != win) && (diceSet.getCurrent(4) != win) && (diceSet.getCurrent(5) != win)){
      diceSet.reroll();
    }
